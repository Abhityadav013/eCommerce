...
const addresses = [
  {
    name: "Abhit",
    street: "116/22 shiv Nagar PataudiRoad Gurgaon",
    pincode: " 122001",
    phone: "9971975330",
  },
  {
    name: "Nikhil",
    street: "62/3 ashok vihar Phase 2 Gurgaon",
    pincode: " 122001",
    phone: "9873635485",
  },
];
    ...
    <div className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-white px-5 mt-1">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list">
                  {addresses.map((address) => (
                    <li
                      key={address.name}
                      className="flex justify-between gap-x-6 py-5 border-solid border-2 px-2 mb-2 border-gray-200"
                    >
